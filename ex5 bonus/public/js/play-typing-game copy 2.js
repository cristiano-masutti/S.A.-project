...
function gameOver() {
    ...
    window.location.assign(`http://localhost:8888/high_scores/game_over?player=${player}&score=${document.querySelector('.score span').innerHTML}&time=${document.querySelector('.time span').innerHTML}&game=test`);
}
