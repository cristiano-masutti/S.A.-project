...
function snake_game_init(canvas, start_button) {
    ...
    document.addEventListener("game.over", (event) => {
        window.location.assign(`http://localhost:8888/high_scores/game_over?player=${player}&score=${document.querySelector('.score span').innerHTML}&time=${document.querySelector('.time span').innerHTML}&game=snake`);
